        ...
        presentationStyle="pageSheet">
            <SafeAreaView className="flex-1 bg-brand-body" edges={["top"]}>
                <View className="flex-row items-center px-5 pt-3 pb-2 gap-3">
                    ...
                    autoFocus
                    className="flex-1 bg-white border border-[#E8E6DF]
                    rounded-full px-4 py-2.5 text-sm text-brand-bg"
                    />
                    <TouchableOpacity
                    onPress={() => {
                        setSearch("");
                ...
                keyboardShouldPersistTaps="handled"
                         renderItem={({item}) => (
                            ...
                            >
                                ...
                                <Text className="text-brand-bd text-sm font-medium w-12">
                                    {item.code}
                                </Text>
                                <Text className="text-brand-text-secondary text-sm flex-1"
                                numberOfLines={1}
                                >
                                    {item.symbol}
                                </Text>
